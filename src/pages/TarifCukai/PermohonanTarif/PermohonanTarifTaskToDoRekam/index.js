...
export default class PermohonanTarifTaskToDoRekam extends Component {
  constructor(props) {
    super(props);
    this.state = {
      subtitle1: "Header",
  ...
  handleSimpanTasktodo = async () => {
    ...
    const response = await requestApi({
      service: "produksi",
      method: "post",
      endpoint: endpoints.permohonanTarifRekamTasktodo,
      body: payload,
  ...
  render() {
    ...
    return (
      <>
        <Container menuName="Task To Do" contentName="Permohonan Tarif Task To Do Rekam">
                ...
                <>
                  <Col span={12}>
                    ...
                    <DatePicker
                      ...
                      format="DD-MM-YYYY"
                      onChange={(date) => this.handleDatepickerChange("tasktodoAwalBerlaku", date)}
                  ...
                  <Col span={12}>
                    ...
                    <DatePicker
                      ...
                      format="DD-MM-YYYY"
                      onChange={(date) => this.handleDatepickerChange("tasktodoTanggalSkep", date)}
