...
export default class CK4HTPembatalan extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleDownloadTemplate = async (e) => {
    ...
    const response = await requestApi({
      service: "produksi",
      method: "get",
      endpoint: `${endpoints.s3Download}/MpgBCAeAW6XX7VrEyFlfBw==/_kS9AjWBFQNLDy9NHZiEjg==/pF24hy4gJU1g7qLuu1KgJRS5NlWup0wDyIROzHyQNTcbeS0wO-lurtc0XC1-vSX-4KgaTnheY72GwTWMuz5ULw==`,
  ...
  render() {
    ...
    return (
      <>
        <Container menuName="Laporan Produksi BKC CK4" contentName="CK4 HT Pembatalan">
