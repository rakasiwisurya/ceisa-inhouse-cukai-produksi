...
export default class CK4MMEATaskToDoPembatalan extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getDetailCk4Mmea = async () => {
    ...
    const response = await requestApi({
      service: "produksi",
      method: "get",
      endpoint: endpoints.ck4MmeaDetailTasktodo,
      params: payload,
  ...
  render() {
    ...
    return (
      <>
        <Container menuName="Task To Do" contentName="CK4 MMEA Task To Do Pembatalan">
