...
export default class ReferensiTarifEdit extends Component {
          ...
          columns: [
            {
              ...
              render: (text, record, index) => (
                <div style={{ display: "flex", justifyContent: "center", gap: 16 }}>
                  ...
                  />
                  {record.idTarifBkcDetail ? (
                    <Button
                      type="danger"
                      icon="delete"
                      onClick={() => this.handleDeleteApi(record, record.idTarifBkcDetail)}
                    />
                  ) : (
  ...
  handleEdit = (record) => {
    this.setState({
      ...
      idTarifBkcDetail: record.idTarifBkcDetail,
    });
  };
  handleDelete = (record) => {
  ...
  handleSimpanPerubahan = async () => {
    const details = this.state.dataSource.map((item) => {
      ...
      if (item.idTarifBkcDetail) data.idTarifBkcDetail = item.idTarifBkcDetail;
                        ...
                        >
                          {this.state.listGolonganBkc.length > 0 &&
                            this.state.listGolonganBkc.map((item, index) => (
                              <Select.Option
                                key={`golonganBkc-${index}`}
                                value={item.idGolonganBkc}
                              >
                      ...
                      <Col span={12}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          <InputNumber
                            id="batasProduksi1"
                            onChange={(value) =>
                              this.handleInputNumberChange("batasProduksi1", value)
                            }
                          ...
                          <InputNumber
                            id="batasProduksi2"
                            onChange={(value) =>
                              this.handleInputNumberChange("batasProduksi2", value)
                            }
                        ...
                        <Row gutter={[16, 16]}>
                          ...
                          <Col span={12}>
                            ...
                            <InputNumber
                              id="kadarBawah"
                              onChange={(value) =>
                                this.handleInputNumberChange("kadarBawah", value)
                              }
                      ...
                      {this.state.idGolonganBkc === 4 && (
                        <Col span={12}>
                          ...
                          <InputNumber
                            id="tarifCukaiImpor"
                            onChange={(value) =>
                              this.handleInputNumberChange("tarifCukaiImpor", value)
                            }
